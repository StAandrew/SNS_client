...
test_df_data = {
    "inputs": ["Predict the price of a stock", #get_price
    ...
    "classes": ["get_price", "get_price", "get_price", "get_price", "get_price", 
                "get_daily_return", "get_daily_return", "get_daily_return", "get_daily_return", "get_daily_return",
                "get_avg_return", "get_avg_return", "get_avg_return", "get_avg_return", "get_avg_return",
                "get_std", "get_std", "get_std", "get_std", "get_std",
                "get_sharpe", "get_sharpe", "get_sharpe", "get_sharpe", "get_sharpe",
...
#Remove punctuation from inputs
test_df["inputs"] = test_df["inputs"].apply(lambda word:[letters.lower() for letters in word if letters not in string.punctuation])
